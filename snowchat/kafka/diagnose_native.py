import os, socket, subprocess, json, shutil, time, sys
...
def main():
    ...
    if REPORT.get('missing_kafka_files') and isinstance(REPORT['missing_kafka_files'], list) and REPORT['missing_kafka_files']:
