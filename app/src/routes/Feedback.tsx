...
| **Model IDs** | \`claude-opus-4-8\` (reasoning/GROUNDED_CITED) and \`claude-haiku-4-5\` (bulk/BULK_VERIFY), defined in \`shared/src/ai/fleet.ts\` (deployed). Never \`claude-fable-5\`. |`
