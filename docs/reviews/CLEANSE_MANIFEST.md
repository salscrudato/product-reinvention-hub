...
| `samples/iso/20-BaseForm-HO3-Homeowners.pdf`, `samples/mock/*.md` | Not consumed by an automated test, but `samples/` is a keep area and these are plausible manual Claims-flow demo fixtures. |
